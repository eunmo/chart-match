...
beforeAll(async () => {
  ...
  songs = [
    [
      { entry: ids[0][0].id, track: 0, id: '1', url: 'https://1' },
      { entry: ids[0][1].id, track: 0, id: '2', url: 'https://2' },
      { entry: ids[0][1].id, track: 1, id: '3', url: 'https://3' },
      { entry: ids[0][2].id, track: 0 },
      { entry: ids[0][3].id, track: 0 },
      { entry: ids[0][4].id, track: 0, id: '4', url: 'https://4' },
      { entry: ids[0][5].id, track: 0 },
      { entry: ids[0][6].id, track: 0, id: '6', url: 'https://6' },
    ],
    [
      { entry: ids[1][0].id, track: 0, id: '1', url: 'https://1' },
      { entry: ids[1][1].id, track: 0, id: '2', url: 'https://2' },
      { entry: ids[1][1].id, track: 1, id: '3', url: 'https://3' },
      { entry: ids[1][2].id, track: 0 },
      { entry: ids[1][3].id, track: 0 },
      { entry: ids[1][4].id, track: 0, id: '5', url: 'https://5' },
      { entry: ids[1][5].id, track: 0, id: '4', url: 'https://4' },
      { entry: ids[1][6].id, track: 0, id: '7', url: 'https://7' },
    ],
    [
      { entry: ids[1][0].id, track: 0, id: '1', url: 'https://1' },
      { entry: ids[1][1].id, track: 0, id: '2', url: 'https://2' },
